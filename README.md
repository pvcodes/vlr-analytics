...
Insights are surfaced through **interactive Looker Studio dashboards** covering player performance, agent meta trends, and map-level statistics — built for analysts and coaches who need fast, reliable access to competitive data. [Jump to Dashboards →](#analytics--dashboards)
...
![Architecture Diagram](images/light_mode_architecture.png)
...
|-----------|-----------|------------|
| Player Performance | [Open](https://lookerstudio.google.com/reporting/a9cd05c6-7055-44cf-b610-a7f3f75d9aab) | [PDF](https://storage.googleapis.com/vlr-stats-public-lake/reports/VLR_Analytics_%E2%80%94_Player_Performance.pdf) |
| Agent Meta | [Open](https://lookerstudio.google.com/reporting/ac430615-353d-4baa-8700-d387fc7eac59) | [PDF](https://storage.googleapis.com/vlr-stats-public-lake/reports/VLR_Analytics_-_Agent_Meta.pdf) |
| Map Stats | [Open](https://lookerstudio.google.com/reporting/592a2e4b-9cab-4e5c-b3ca-48cbf45d9159) | [PDF](https://storage.googleapis.com/vlr-stats-public-lake/reports/VLR_Analytics_-_Map_Stats.pdf) |

> PDF backups are available if live dashboards are unavailable due to budget limits.

### Notebook Exploration

[Gold Layer Exploration Notebook](./functions/vlr-gold-transform/notebook/gold_exploration.ipynb)
